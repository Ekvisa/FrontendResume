...
const translations = {
  en: {
    ...
    aim_tip: "I want to grow",
    hobby_tip: "My cup of tea",
    contacts_tip: "How to contact",
    experience_tip: "What I worked with",
    values_tip: "The heart wants",
    education_tip: "What I stand on",
    title: "Resume",
    hello:
      "Hi, I'm Katya. I have experience in web development and testing. I can see the project as a whole and catch the little things.",
    comment:
      "Play with the picture — it’s there for a reason! Or open everything at once — I won’t mind",
    const: "const is for the past, it cannot be changed",
    let: "let is for skills, they can be supplemented",
    "data-structures":
      "Data structures in blocks were selected according to meaning",
    aim: "Aim",
    aim_grow: "Grow",
    aim_f1: "diveintoComplexTasks",
    aim_f2: "writeCleanCode",
    aim_f3: "makeInterfacesThatCare",
    skills: "Skills",
    skills_layout: "Markup and styles",
    skills_adapt: "adaptive design",
    skills_var: "variables",
    skills_sem: "semantics",
    skills_lang: "Programming languages",
    skills_frameworks: "Frameworks",
    skills_data: "Working with data",
    skills_tools: "Tools",
    skills_foreign: "Foreign languages",
    skills_en: "English",
    skills_b2: "fluent reading of technical and general literature",
    experience: "Experience",
    experience_petproj: "Pet projects",
    experience_perspract: "My personal practice",
    experience_selproj: "//selected projects",
    experience_petproj_pet1: "Search for lost cats",
    experience_petproj_pet2: "Custom cooling stones",
    experience_allproj: "//all projects",
    ...
    education_unver: "Samara State University",
    education_transl: "Translator in the field of professional communication",
    education_fe: "Frontend development",
    values: "Values",
    values1:
      "I love turning ideas into beautiful, user-friendly, and dynamic projects.",
    values2:
      "It’s important to me to pride my work and see the value it brings.",
    values3: "I believe even small efforts can make a difference in the world.",
    hobby: "Hobbies",
    hobby_create: " ",
    hobby_create_draw: "drawing",
    hobby_create_pot: "pottery",
    hobby_create_pet: "pet projects",
    hobby_explore: " ",
    hobby_explore_foreign: "foreign languages",
    hobby_explore_sci: "science",
    hobby_explore_fic: "fiction books",
    contacts: "Contacts",
  },
  ru: {
    ...
    aim_tip: "Куда хочу расти",
    hobby_tip: 'Моя "cup of tea"',
    contacts_tip: "Как связаться",
    experience_tip: "С чем имела дело",
    values_tip: "К чему лежит душа",
    education_tip: "На что опираюсь",
    title: "Резюме",
    hello:
      "Привет, я Катя. Имею опыт в веб-разработке и тестировании. Умею видеть проект целиком и ловить мелочи.",
    comment:
      "Поиграй с картинкой — она не просто так! Или раскрой сразу всё — я не обижусь",
    const: "const - для прошлого, его не изменить",
    let: "let - для навыков, их можно дополнять",
    "data-structures": "Структуры данных в блоках подобраны по смыслу",
    aim: "Цель",
    aim_grow: "Расти",
    aim_f1: "погружатьсяВСложныеЗадачи",
    aim_f2: "писатьЧистыйКод",
    aim_f3: "создаватьИнтерфейсыСЗаботойОЛюдях",
    skills: "Навыки",
    skills_layout: "Разметка и стили",
    skills_adapt: "адаптивность",
    skills_var: "переменные",
    skills_sem: "семантика",
    skills_lang: "Языки программирования",
    skills_frameworks: "Фреймворки",
    skills_data: "Работа с данными",
    ...
    experience: "Опыт",
    experience_petproj: "Пет-проекты",
    experience_perspract: "Моя личная практика",
    experience_selproj: "//избранные проекты",
    experience_petproj_pet1: "Поиск пропавших котиков",
    experience_petproj_pet2: "Авторские охлаждающие камни",
    experience_allproj: "//все проекты",
    ...
    education_transl: "Переводчик в сфере профессиональной коммуникации",
    education_fe: "Frontend разработка",
    values: "Ценности",
    values1: "Люблю превращать идеи в красивые, удобные и живые проекты.",
    values2:
      "Мне важно гордиться тем, что делаю, и видеть, как работа приносит пользу.",
    values3: "Верю, что даже маленькие усилия могут менять мир.",
    hobby: "Хобби",
    hobby_create: "//создавать",
    hobby_create_paint: "рисование",
    hobby_create_pot: "керамика",
    hobby_create_pet: "пет-проекты",
    hobby_explore: "//и изучать",
    hobby_explore_foreign: "иностранные языки",
    hobby_explore_sci: "наука",
    hobby_explore_fic: "художественные книги",
    contacts: "Контакты",
  },
};
